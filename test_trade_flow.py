...
def check_save():
    ...
    # Бектест записують тільки на сайті: угода з бота завжди справжня, і
    # позначки типу в ній немає взагалі — база підставить порожню.
    check("угода з бота — реальна", not t.get("kind"))
