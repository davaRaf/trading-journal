...
check("підсумку «правил без порушень» більше немає",
      h.indexOf("правил без") < 0 && h.indexOf("rules kept") < 0);
check("саме число підсумку лишилось", /tsv-score"><b>\d+ \/ \d+<\/b><\/div>/.test(h));
