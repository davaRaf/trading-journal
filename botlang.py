...
PHRASES = {
    ...
    "resOpen":     ("В роботі", "В работе", "In progress"),
    ...
    "shotLimit":   ("До однієї угоди — не більше 20 скрінів.",
                    "К одной сделке — не больше 20 скринов.",
                    "Up to 20 screenshots per trade."),
    ...
    # ---- посилання на угоду (bot_share.py) ----
    "shAsk":       ("Зробити посилання на цю угоду, щоб поділитись?",
                    "Сделать ссылку на эту сделку, чтобы поделиться?",
                    "Make a link to this trade to share it?"),
    "shYes":       ("Так, посилання", "Да, ссылку", "Yes, a link"),
    "shNo":        ("Не треба", "Не нужно", "No need"),
    "shSkipped":   ("Добре, без посилання.", "Хорошо, без ссылки.", "Okay, no link."),
    "shTtl":       ("Скільки посилання має жити?", "Сколько ссылка должна жить?",
                    "How long should the link live?"),
    "ttl1h":       ("1 година", "1 час", "1 hour"),
    "ttl24h":      ("24 години", "24 часа", "24 hours"),
    "ttl7d":       ("7 днів", "7 дней", "7 days"),
    "ttl30d":      ("30 днів", "30 дней", "30 days"),
    "ttlForever":  ("Назавжди", "Навсегда", "Forever"),
    "shSkin":      ("Яке оформлення?", "Какое оформление?", "Which style?"),
    "shSkinPlain": ("Звичайне", "Обычное", "Regular"),
    "shDone":      ("Посилання готове — можна ділитись:", "Ссылка готова — можно делиться:",
                    "Your link is ready — share away:"),
    "shLives":     ("Діє: %s", "Действует: %s", "Valid for: %s"),
    "shGone":      ("Цю угоду вже не знайти.", "Эту сделку уже не найти.",
                    "Can't find that trade anymore."),
    # підписи в самому знімку — як на сайті (static/i18n.js)
    "shKindTrade":   ("угода", "сделка", "trade"),
    "shKindBtTrade": ("бектест · угода", "бэктест · сделка", "backtest · trade"),
    "shOgTrade":     ("Угода", "Сделка", "Trade"),
    "shOgBtTrade":   ("Бектест · угода", "Бэктест · сделка", "Backtest · trade"),
    "shTotal":       ("Підсумок", "Итог", "Total"),
    "shEntryBlock":  ("Вхід", "Вход", "Entry"),
    "shNotes":       ("НОТАТКИ", "ЗАМЕТКИ", "NOTES"),
    "shMistakes":    ("ПОМИЛКИ", "ОШИБКИ", "MISTAKES"),
    "shEntryType":   ("Тип входу", "Тип входа", "Entry type"),
    "shModel":       ("Модель", "Модель", "Model"),
    "fRiskPlain":    ("Ризик", "Риск", "Risk"),
    "resHandFull":   ("TP руками", "TP руками", "TP by hand"),
