...
uk: {
  ...
  emotions: ["Спокій","Впевненість","Жадібність","Страх","Азарт","Помста","Нудьга","ФОМО"],
  ...
  anTitle: "Аналітика", anResultsPrefix: "Результати ·",
  anColName: "Назва", anNoData: "Немає даних — поле не заповнене в жодній угоді",
  lkTitle: "Зв'язки", lkCombo: "Сполучення", lkFields: "Поля",
  lkNote: "Перебрали сполучення полів за тебе. Показані ті, де не менше <b>%d</b> угод — на меншому відсоток нічого не означає.",
  ...
  errBadImage: "файл не схожий на картинку — потрібен PNG, JPG, WEBP або GIF",
  ...
  ntStep1Lead: "Перенесемо журнал із Notion цілком — угоди, нотатки й скріншоти.",
  ntStep1Li1: "У Notion: <b>Share</b> → увімкни <b>Publish to web</b>.",
  ntStep1Li2: "<b>Copy web link</b> → встав посилання сюди.",
  ntLinkLabel: "Посилання на таблицю",
  ntLinkNote: "Посилання має вести на таблицю — ту, де рядки й колонки.",
  ...
  ntVideoTitle: "Що відкрити в Notion, щоб підтяглися сесії та сетапи",
  ...
  ntSaveBackup: "Зберегти копію",
  ntFieldRequired: "Без цієї колонки перенести не вийде",
  ...
  nwNoFiltered: "За цим фільтром подій немає.", nwSearchPh: "Пошук новини за назвою",
  ...
  nwColDate: "дата", nwColTime: "час", nwColImp: "вплив", nwColEvent: "подія",
  nwColFact: "факт", nwColHist: "історія",
  nwViewDay: "День", nwViewWeek: "Тиждень", nwToday: "сьогодні",
  nwPrevDay: "Попередній день", nwNextDay: "Наступний день",
  nwNext: "далі", nwNow: "зараз", nwDeviation: "відхилення",
  nwPrevOut: "Попередні виходи",
  nwOneHigh: "Червона", nwOneMed: "Помаранчева", nwOneLow: "Жовта", nwOneHol: "Вихідний",
  nwTimezone: "Часовий пояс", nwTzAuto: "Як на пристрої",
  nwFilter: "Фільтр", nwApply: "Застосувати", nwCancel: "Скасувати",
  nwReset: "Скинути фільтр", nwPickAll: "усі", nwPickNone: "жодної",
  nwTypes: "Тип події",
  nwTypeGrowth: "Зростання", nwTypeInfl: "Інфляція", nwTypeJobs: "Зайнятість",
  nwTypeCb: "Центробанк", nwTypeBonds: "Облігації", nwTypeHouse: "Житло",
  nwTypeConsum: "Опитування споживачів", nwTypeBiz: "Опитування бізнесу",
  nwTypeTalk: "Виступи", nwTypeMisc: "Інше",
  ...
  fmRRPlanHint: "Скільки дав би тейк, якби досидів. Не обов'язково.",
  kSkips: "Скіпів", kSkipsTip: "Сетап був, ти його не взяв. У вінрейт і середні не йде: угоди не було",
  kHands: "Закрив руками", kHandsTip: "Тейків, до яких ціна дійшла не сама",
  kHandOut: "Недобрав", kHandOutTip: "Скільки лишилось на столі через вихід раніше цілі",
  calSkipTip: "Скіп: сетап був, входу не було",
  calOpenTip: "В роботі: угода ще не закрилась",
  calHandTip: "Тейк, закритий руками",
  slKindReview: "аналіз дня", slOgReview: "Аналіз дня",
  slKindRvMonth: "аналіз дня · місяць", slOgRvMonth: "Аналіз дня за місяць",
  slKindQuarter: "квартал", slOgQuarter: "Зведення за квартал", slQuarterLabel: "Який квартал",
  shMonthsTitle: "Місяці", shMonthsHint: "Натисни на місяць — відкриється календар, на день — угоди зі скрінами.",
  shRvmTitle: "Розбори по днях", shRvmDays: "Днів з розбором",
  shRvmHint: "Зелений — ринок пішов за планом, жовтий — частково, червоний — ні, контур — план є, вечір не записаний.",
  shRvmOk: "за планом", shRvmPart: "частково", shRvmNo: "не за планом", shRvmOpen: "без вечора",
  shRvmTap: "Натисни на день — побачиш, як він дивився на ринок.", shRvmEmpty: "У цей день розбір без деталей.",
  ...
  fBtRun: "Журнал", fmBtRunPh: "US100 · NY сесія",
  btTsNote: "рахуємо по бектесту",
  btEmpty: "У цьому журналі ще порожньо. Запиши першу угоду — статистика рахуватиметься тільки по ньому.",
  btNoJ: "Бектест ведеться журналами: окремий журнал на кожен актив чи ідею, у кожного своя статистика.",
  bgBtjTag: "з чого почати", bgBtjTitle: "Завести журнал бектесту",
  bgBtjText: "Назва, актив і період історії. Далі угоди пишуться в нього й рахуються окремо.",
  alertNeedJournal: "Обери журнал, у який записати угоду",
  ...
  stLogoutLead: "Лише на цьому пристрої. Журнал і записи нікуди не зникнуть.",
  helloHi: "Ласкаво просимо", helloGlad: "Раді тебе бачити",
  stProfile: "Профіль", stGeneral: "Загальні", stAccount: "Акаунт", stSecurity: "Безпека",
  stTodo: "Є що зробити", stProfileSub: "Профіль, фото, статистика",
  mePresets: "Або обери готову", meAllPresets: "Усі аватарки", meLessPresets: "Згорнути",
  av_wink: "Підморгує", av_shades: "В окулярах", av_surprised: "Здивований", av_focused: "Зосереджений", av_laugh: "Сміється",
  av_sleepy: "Сонний", av_love: "Закоханий", av_stars: "Зірки в очах", av_sly: "Хитрий", av_bull: "Бик",
  av_bear: "Ведмежа", av_headphones: "У навушниках", av_cap: "У кепці", av_tongue: "Дражниться", av_robot: "Робот",
  meFree: "Зараз безкоштовно", meUpload: "Завантажити фото", meChange: "Змінити фото", meRemove: "Прибрати",
  meEditNick: "Змінити нікнейм", meNick: "Нікнейм", meSave: "Зберегти нік", meCancel: "Скасувати",
  meNickBad: "3–24 символи: латиниця, цифри, _ . -", meNickTaken: "Цей нік уже зайнятий",
  meNickFree: "Вільний", meNickWait: "Забагато спроб — зачекай хвилину",
  mePhotoErr: "Не вдалося завантажити фото. Спробуй інше (JPG, PNG, WebP).",
  meCropTitle: "Фото профілю", meCropHint: "Перетягни фото й обери масштаб",
  meZoom: "Масштаб", meZoomIn: "Наблизити", meZoomOut: "Віддалити",
  meCropReset: "Скинути", meCropSave: "Зберегти",
  meStats: "Статистика", meWithUs: "днів з нами", meTrades: "угод", meDays: "торгових днів",
  meStreak: "днів поспіль", meReviews: "розборів дня",
  meHeat: "Активність", meCalPrev: "Попередній місяць", meCalNext: "Наступний місяць",
  meCalWd: ["Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Нд"],
  meCalSum: "%1 з %2 днів із записами",
  meHeatTrades: "угоди", meHeatReview: "розбір дня", meHeatShares: "посилання",
  meHeatNone: "нічого не записано",
  mePairs: "Найчастіше торгуєш", meNoPairs: "Ще немає угод",
  meBadges: "Відмітки", bdFirst: "Перша угода", bdFirstHow: "запиши першу угоду",
  bdHundred: "100 угод", bdStreak: "7 днів поспіль", bdReviews: "50 розборів дня",
  bdLeft: "лишилось %d", bdBest: "найкраща серія %d", bdDone: "отримано",
  ...
  gsGateTitle: "Щоб записувати — увійди",
  gsGateTrade: "Щоб записати угоду — увійди",
  gsGateTs: "Щоб описати свою ТС — увійди",
  gsGateConnect: "Щоб підключити — увійди",
  ...
  bgLead: "Журнал твій і порожній. Якщо ти вже вів угоди в Notion — перенесемо все за одним посиланням: угоди, нотатки зі сторінок і скріншоти. Копіювати руками нічого не треба.",
  ...
  pubBarMine: "Твій журнал таким бачать інші",
  ...
  pubNeedText: "Реєстрація займає хвилину. Разом з нею ти отримуєш свій журнал: угоди, скріни, статистику й ТС.",
  ...
  pwSave: "Змінити пароль", pwSaving: "Міняю…", pwDone: "Готово — пароль змінено, інші пристрої вийшли",
  pwBack: "Назад",
  ...
  tfTitle: "Двоетапний вхід",
  tfOffState: "вимкнено", tfOnState: "увімкнено",
  tfLeadOff: "Крім пароля, під час входу спитаємо 6 цифр із застосунку на телефоні — Google Authenticator, Authy чи схожого. Навіть знаючи пароль, чужий без твого телефона не зайде.",
  tfLeadOn: "Під час входу питаємо код із застосунку. Запасних кодів лишилось: %d.",
  tfEnable: "Увімкнути", tfDisable: "Вимкнути", tfNewBackup: "Нові запасні коди",
  tfDisableTitle: "Вимкнути двоетапний вхід",
  tfStep1: "Відкрий застосунок-автентифікатор (Google Authenticator, Authy) і натисни «+», щоб додати акаунт.",
  tfStep2: "Відскануй QR-код. Якщо ти на телефоні — просто натисни «Відкрити в застосунку».",
  tfManual: "Не виходить сканувати? Введи ключ вручну:",
  tfQrAria: "QR-код для застосунку-автентифікатора",
  tfKeyAria: "Ключ для застосунку",
  tfCopy: "Скопіювати", tfCopied: "Скопійовано", tfCopyAll: "Скопіювати всі",
  tfOpenApp: "Відкрити в застосунку",
  tfStep3: "Введи 6 цифр, які показує застосунок.",
  tfCode: "Код із застосунку", tfCodeOrBackup: "Код із застосунку або запасний",
  tfConfirm: "Увімкнути", tfBusy: "Перевіряю…",
  tfOnDone: "Двоетапний вхід увімкнено. Інші пристрої вийшли з журналу.",
  tfBackupTitle: "Запасні коди",
  tfBackupLead: "Якщо телефона не буде під рукою, увійдеш одним із цих кодів. Кожен спрацьовує один раз. Збережи їх — більше ми їх не покажемо.",
  tfDownload: "Завантажити файлом", tfDone: "Готово, зберіг",
  tfAskDisable: "Щоб вимкнути двоетапний вхід, введи код із застосунку або запасний код.",
  tfAskBackup: "Старі запасні коди перестануть працювати. Введи код із застосунку або запасний код.",
  tfErrEmpty: "Введи код", tfErrBad: "Код не підходить — перевір, чи точний час на телефоні",
  tfErrExpired: "Час вийшов — почнімо спочатку", tfErrMany: "Забагато спроб — спробуй за %d с",
  loTitle: "Пристрої",
  loLead: "Заходив у журнал на чужому комп'ютері чи загубив телефон — вийди скрізь. Цей пристрій лишиться в журналі.",
  loBtn: "Вийти на всіх інших пристроях", loAsk: "Вийти з журналу на всіх інших пристроях?",
  loYes: "Вийти", loDone: "Готово — інші пристрої вийшли",
  ...
  ppLink: "Посилання на твій журнал",
  ...
  ppOpenNote: "Журнал відкритий: його побачить кожен, кому ти даси посилання.",
  ppNeedNick: "Спершу увійди — посилання робиться з твого ніка.",
  ...
  suEmail: "Пошта",
  suTelegram: "Telegram · Данило",
  suTelegram2: "Telegram · Давид",
  suWrite: "Написати",
...
ru: {
  ...
  emotions: ["Спокойствие","Уверенность","Жадность","Страх","Азарт","Месть","Скука","ФОМО"],
  ...
  anTitle: "Аналитика", anResultsPrefix: "Результаты ·",
  anColName: "Название", anNoData: "Нет данных — поле не заполнено ни в одной сделке",
  lkTitle: "Связки", lkCombo: "Сочетание", lkFields: "Поля",
  lkNote: "Перебрали сочетания полей за тебя. Показаны те, где не меньше <b>%d</b> сделок — на меньшем процент ничего не значит.",
  ...
  errBadImage: "файл не похож на картинку — нужен PNG, JPG, WEBP или GIF",
  ...
  ntStep1Lead: "Перенесём журнал из Notion целиком — сделки, заметки и скриншоты.",
  ntStep1Li1: "В Notion: <b>Share</b> → включи <b>Publish to web</b>.",
  ntStep1Li2: "<b>Copy web link</b> → вставь ссылку сюда.",
  ntLinkLabel: "Ссылка на таблицу",
  ntLinkNote: "Ссылка должна вести на таблицу — ту, где строки и колонки.",
  ...
  ntVideoTitle: "Что открыть в Notion, чтобы подтянулись сессии и сетапы",
  ...
  ntSaveBackup: "Сохранить копию",
  ntFieldRequired: "Без этой колонки перенести не выйдет",
  ...
  nwNoFiltered: "По этому фильтру событий нет.", nwSearchPh: "Поиск новости по названию",
  ...
  nwColDate: "дата", nwColTime: "время", nwColImp: "влияние", nwColEvent: "событие",
  nwColFact: "факт", nwColHist: "история",
  nwViewDay: "День", nwViewWeek: "Неделя", nwToday: "сегодня",
  nwPrevDay: "Предыдущий день", nwNextDay: "Следующий день",
  nwNext: "далее", nwNow: "сейчас", nwDeviation: "отклонение",
  nwPrevOut: "Предыдущие выходы",
  nwOneHigh: "Красная", nwOneMed: "Оранжевая", nwOneLow: "Жёлтая", nwOneHol: "Выходной",
  nwTimezone: "Часовой пояс", nwTzAuto: "Как на устройстве",
  nwFilter: "Фильтр", nwApply: "Применить", nwCancel: "Отмена",
  nwReset: "Сбросить фильтр", nwPickAll: "все", nwPickNone: "ни одного",
  nwTypes: "Тип события",
  nwTypeGrowth: "Рост", nwTypeInfl: "Инфляция", nwTypeJobs: "Занятость",
  nwTypeCb: "Центробанк", nwTypeBonds: "Облигации", nwTypeHouse: "Жильё",
  nwTypeConsum: "Опросы потребителей", nwTypeBiz: "Опросы бизнеса",
  nwTypeTalk: "Выступления", nwTypeMisc: "Прочее",
  ...
  fmRRPlanHint: "Сколько дал бы тейк, если бы досидел. Необязательно.",
  kSkips: "Скипов", kSkipsTip: "Сетап был, ты его не взял. В винрейт и средние не идёт: сделки не было",
  kHands: "Закрыл руками", kHandsTip: "Тейков, до которых цена дошла не сама",
  kHandOut: "Недобрал", kHandOutTip: "Сколько осталось на столе из-за выхода раньше цели",
  calSkipTip: "Скип: сетап был, входа не было",
  calOpenTip: "В работе: сделка ещё не закрылась",
  calHandTip: "Тейк, закрытый руками",
  slKindReview: "анализ дня", slOgReview: "Анализ дня",
  slKindRvMonth: "анализ дня · месяц", slOgRvMonth: "Анализ дня за месяц",
  slKindQuarter: "квартал", slOgQuarter: "Сводка за квартал", slQuarterLabel: "Какой квартал",
  shMonthsTitle: "Месяцы", shMonthsHint: "Нажми на месяц — откроется календарь, на день — сделки со скринами.",
  shRvmTitle: "Разборы по дням", shRvmDays: "Дней с анализом",
  shRvmHint: "Зелёный — рынок пошёл по плану, жёлтый — частично, красный — нет, контур — план есть, вечер не записан.",
  shRvmOk: "по плану", shRvmPart: "частично", shRvmNo: "не по плану", shRvmOpen: "без вечера",
  shRvmTap: "Нажми на день — увидишь, как он смотрел на рынок.", shRvmEmpty: "В этот день разбор без деталей.",
  ...
  fBtRun: "Журнал", fmBtRunPh: "US100 · NY сессия",
  btTsNote: "считаем по бэктесту",
  btEmpty: "В этом журнале пока пусто. Запиши первую сделку — статистика будет считаться только по нему.",
  btNoJ: "Бэктест ведётся журналами: отдельный журнал на каждый актив или идею, у каждого своя статистика.",
  bgBtjTag: "с чего начать", bgBtjTitle: "Завести журнал бэктеста",
  bgBtjText: "Название, актив и период истории. Дальше сделки пишутся в него и считаются отдельно.",
  alertNeedJournal: "Выбери журнал, в который записать сделку",
  ...
  stLogoutLead: "Только на этом устройстве. Журнал и записи никуда не пропадут.",
  helloHi: "Добро пожаловать", helloGlad: "Рады тебя видеть",
  stProfile: "Профиль", stGeneral: "Общие", stAccount: "Аккаунт", stSecurity: "Безопасность",
  stTodo: "Есть что сделать", stProfileSub: "Профиль, фото, статистика",
  mePresets: "Или выбери готовую", meAllPresets: "Все аватарки", meLessPresets: "Свернуть",
  av_wink: "Подмигнул", av_shades: "В очках", av_surprised: "Удивлён", av_focused: "Сосредоточен", av_laugh: "Смеётся",
  av_sleepy: "Сонный", av_love: "Влюблён", av_stars: "Звёзды в глазах", av_sly: "Хитрый", av_bull: "Бык",
  av_bear: "Медвежонок", av_headphones: "В наушниках", av_cap: "В кепке", av_tongue: "Дразнится", av_robot: "Робот",
  meFree: "Сейчас бесплатно", meUpload: "Загрузить фото", meChange: "Сменить фото", meRemove: "Убрать",
  meEditNick: "Изменить никнейм", meNick: "Никнейм", meSave: "Сохранить ник", meCancel: "Отменить",
  meNickBad: "3–24 символа: латиница, цифры, _ . -", meNickTaken: "Этот ник уже занят",
  meNickFree: "Свободен", meNickWait: "Слишком много попыток — подожди минуту",
  mePhotoErr: "Не получилось загрузить фото. Попробуй другое (JPG, PNG, WebP).",
  meCropTitle: "Фото профиля", meCropHint: "Перетащи фото и выбери масштаб",
  meZoom: "Масштаб", meZoomIn: "Приблизить", meZoomOut: "Отдалить",
  meCropReset: "Сбросить", meCropSave: "Сохранить",
  meStats: "Статистика", meWithUs: "дней с нами", meTrades: "сделок", meDays: "торговых дней",
  meStreak: "дней подряд", meReviews: "разборов дня",
  meHeat: "Активность", meCalPrev: "Предыдущий месяц", meCalNext: "Следующий месяц",
  meCalWd: ["Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс"],
  meCalSum: "%1 из %2 дней с записями",
  meHeatTrades: "сделки", meHeatReview: "разбор дня", meHeatShares: "ссылки",
  meHeatNone: "ничего не записано",
  mePairs: "Чаще всего торгуешь", meNoPairs: "Пока нет сделок",
  meBadges: "Отметки", bdFirst: "Первая сделка", bdFirstHow: "запиши первую сделку",
  bdHundred: "100 сделок", bdStreak: "7 дней подряд", bdReviews: "50 разборов дня",
  bdLeft: "осталось %d", bdBest: "лучшая серия %d", bdDone: "получено",
  ...
  gsGateTitle: "Чтобы записывать — войди",
  gsGateTrade: "Чтобы записать сделку — войди",
  gsGateTs: "Чтобы описать свою ТС — войди",
  gsGateConnect: "Чтобы подключить — войди",
  ...
  bgLead: "Журнал твой и пустой. Если ты уже вёл сделки в Notion — перенесём всё по одной ссылке: сделки, заметки со страниц и скриншоты. Копировать руками ничего не нужно.",
  ...
  pubBarMine: "Твой журнал таким видят другие",
  ...
  pubNeedText: "Регистрация занимает минуту. Вместе с ней ты получаешь свой журнал: сделки, скрины, статистику и ТС.",
  pubCtaAll: "Весь журнал %s",
  ...
  pwSave: "Сменить пароль", pwSaving: "Меняю…", pwDone: "Готово — пароль изменён, другие устройства вышли",
  pwBack: "Назад",
  ...
  tfTitle: "Двухэтапный вход",
  tfOffState: "выключен", tfOnState: "включён",
  tfLeadOff: "Кроме пароля, при входе спросим 6 цифр из приложения на телефоне — Google Authenticator, Authy или похожего. Даже зная пароль, чужой без твоего телефона не войдёт.",
  tfLeadOn: "При входе спрашиваем код из приложения. Запасных кодов осталось: %d.",
  tfEnable: "Включить", tfDisable: "Выключить", tfNewBackup: "Новые запасные коды",
  tfDisableTitle: "Выключить двухэтапный вход",
  tfStep1: "Открой приложение-аутентификатор (Google Authenticator, Authy) и нажми «+», чтобы добавить аккаунт.",
  tfStep2: "Отсканируй QR-код. Если ты на телефоне — просто нажми «Открыть в приложении».",
  tfManual: "Не получается отсканировать? Введи ключ вручную:",
  tfQrAria: "QR-код для приложения-аутентификатора",
  tfKeyAria: "Ключ для приложения",
  tfCopy: "Скопировать", tfCopied: "Скопировано", tfCopyAll: "Скопировать все",
  tfOpenApp: "Открыть в приложении",
  tfStep3: "Введи 6 цифр, которые показывает приложение.",
  tfCode: "Код из приложения", tfCodeOrBackup: "Код из приложения или запасной",
  tfConfirm: "Включить", tfBusy: "Проверяю…",
  tfOnDone: "Двухэтапный вход включён. Другие устройства вышли из журнала.",
  tfBackupTitle: "Запасные коды",
  tfBackupLead: "Если телефона не будет под рукой, войдёшь одним из этих кодов. Каждый срабатывает один раз. Сохрани их — больше мы их не покажем.",
  tfDownload: "Скачать файлом", tfDone: "Готово, сохранил",
  tfAskDisable: "Чтобы выключить двухэтапный вход, введи код из приложения или запасной код.",
  tfAskBackup: "Старые запасные коды перестанут работать. Введи код из приложения или запасной код.",
  tfErrEmpty: "Введи код", tfErrBad: "Код не подходит — проверь, точное ли время на телефоне",
  tfErrExpired: "Время вышло — начнём заново", tfErrMany: "Слишком много попыток — попробуй через %d с",
  loTitle: "Устройства",
  loLead: "Заходил в журнал на чужом компьютере или потерял телефон — выйди везде. Это устройство останется в журнале.",
  loBtn: "Выйти на всех других устройствах", loAsk: "Выйти из журнала на всех других устройствах?",
  loYes: "Выйти", loDone: "Готово — другие устройства вышли",
  ...
  ppOpenNote: "Журнал открыт: его увидит каждый, кому ты дашь ссылку.",
  ppNeedNick: "Сначала войди — ссылка делается из твоего ника.",
...
en: {
  ...
  emotions: ["Calm","Confidence","Greed","Fear","Excitement","Revenge","Boredom","FOMO"],
  ...
  anTitle: "Analytics", anResultsPrefix: "Results ·",
  ...
  errBadImage: "file doesn't look like an image — use PNG, JPG, WEBP or GIF",
  ...
  ntStep1Lead: "We'll bring your whole Notion journal over — trades, notes and screenshots.",
  ntStep1Li1: "In Notion: <b>Share</b> → turn on <b>Publish to web</b>.",
  ntStep1Li2: "<b>Copy web link</b> → paste the link here.",
  ntLinkLabel: "Link to the table",
  ntLinkNote: "The link must point to the table — the one with rows and columns.",
  ...
  ntVideoTitle: "What to publish in Notion so sessions and setups come through",
  ...
  ntSaveBackup: "Save a copy",
  ntFieldRequired: "Without this column the import can't run",
  ...
  nwNoFiltered: "No events match this filter.", nwSearchPh: "Search news by title",
  ...
  nwColDate: "date", nwColTime: "time", nwColImp: "impact", nwColEvent: "event",
  nwColFact: "actual", nwColHist: "history",
  nwViewDay: "Day", nwViewWeek: "Week", nwToday: "today",
  nwPrevDay: "Previous day", nwNextDay: "Next day",
  nwNext: "next", nwNow: "now", nwDeviation: "deviation",
  nwPrevOut: "Previous releases",
  nwOneHigh: "Red", nwOneMed: "Orange", nwOneLow: "Yellow", nwOneHol: "Holiday",
  nwTimezone: "Time zone", nwTzAuto: "Same as device",
  nwFilter: "Filter", nwApply: "Apply", nwCancel: "Cancel",
  nwReset: "Remove filter", nwPickAll: "all", nwPickNone: "none",
  nwTypes: "Event type",
  nwTypeGrowth: "Growth", nwTypeInfl: "Inflation", nwTypeJobs: "Employment",
  nwTypeCb: "Central bank", nwTypeBonds: "Bonds", nwTypeHouse: "Housing",
  nwTypeConsum: "Consumer surveys", nwTypeBiz: "Business surveys",
  nwTypeTalk: "Speeches", nwTypeMisc: "Misc",
  ...
  fmRRPlanHint: "What the target would have paid if you had sat through it. Optional.",
  kSkips: "Skips", kSkipsTip: "The setup was there and you passed. Not counted in win rate or averages: there was no trade",
  kHands: "Closed by hand", kHandsTip: "Targets the price did not reach on its own",
  kHandOut: "Left on the table", kHandOutTip: "How much the early exits cost",
  calSkipTip: "Skip: the setup was there, the entry was not",
  calOpenTip: "In progress: the trade hasn't closed yet",
  calHandTip: "Target closed by hand",
  slKindReview: "day review", slOgReview: "Day review",
  slKindRvMonth: "day review · month", slOgRvMonth: "Day reviews for the month",
  slKindQuarter: "quarter", slOgQuarter: "Quarter summary", slQuarterLabel: "Which quarter",
  shMonthsTitle: "Months", shMonthsHint: "Tap a month to open its calendar, tap a day to see the trades.",
  shRvmTitle: "Reviews by day", shRvmDays: "Days reviewed",
  shRvmHint: "Green — market went as planned, yellow — partly, red — no, outline — plan written, no evening yet.",
  shRvmOk: "as planned", shRvmPart: "partly", shRvmNo: "off plan", shRvmOpen: "no evening",
  shRvmTap: "Tap a day to see how the market was read.", shRvmEmpty: "No details recorded for this day.",
  ...
  fBtRun: "Journal", fmBtRunPh: "US100 · NY session",
  btTsNote: "counted on the backtest",
  btEmpty: "This journal is still empty. Log the first trade — its stats count for this journal only.",
  btNoJ: "Backtests live in journals: one journal per asset or idea, each with its own stats.",
  bgBtjTag: "start here", bgBtjTitle: "Create a backtest journal",
  bgBtjText: "Name, asset and history period. Trades then go into it and count separately.",
  alertNeedJournal: "Pick the journal this trade goes into",
  ...
  stLogoutLead: "Only on this device. Your journal and entries stay put.",
  helloHi: "Welcome", helloGlad: "Good to see you",
  stProfile: "Profile", stGeneral: "General", stAccount: "Account", stSecurity: "Security",
  stTodo: "Needs attention", stProfileSub: "Profile, photo, stats",
  mePresets: "Or pick a ready one", meAllPresets: "All avatars", meLessPresets: "Show less",
  av_wink: "Wink", av_shades: "Shades", av_surprised: "Surprised", av_focused: "Focused", av_laugh: "Laughing",
  av_sleepy: "Sleepy", av_love: "In love", av_stars: "Starry-eyed", av_sly: "Sly", av_bull: "Bull",
  av_bear: "Bear cub", av_headphones: "Headphones", av_cap: "Cap", av_tongue: "Teasing", av_robot: "Robot",
  meFree: "Free for now", meUpload: "Upload photo", meChange: "Change photo", meRemove: "Remove",
  meEditNick: "Change nickname", meNick: "Nickname", meSave: "Save nickname", meCancel: "Cancel",
  meNickBad: "3–24 characters: letters, digits, _ . -", meNickTaken: "This nickname is taken",
  meNickFree: "Available", meNickWait: "Too many attempts — wait a minute",
  mePhotoErr: "Couldn't upload the photo. Try another one (JPG, PNG, WebP).",
  meCropTitle: "Profile photo", meCropHint: "Drag the photo and pick the zoom",
  meZoom: "Zoom", meZoomIn: "Zoom in", meZoomOut: "Zoom out",
  meCropReset: "Reset", meCropSave: "Save",
  meStats: "Stats", meWithUs: "days with us", meTrades: "trades", meDays: "trading days",
  meStreak: "days in a row", meReviews: "day reviews",
  meHeat: "Activity", meCalPrev: "Previous month", meCalNext: "Next month",
  meCalWd: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
  meCalSum: "%1 of %2 days with entries",
  meHeatTrades: "trades", meHeatReview: "day review", meHeatShares: "links",
  meHeatNone: "nothing logged",
  mePairs: "Most traded", meNoPairs: "No trades yet",
  meBadges: "Badges", bdFirst: "First trade", bdFirstHow: "log your first trade",
  bdHundred: "100 trades", bdStreak: "7 days in a row", bdReviews: "50 day reviews",
  bdLeft: "%d to go", bdBest: "best streak %d", bdDone: "earned",
  ...
  pwSave: "Change password", pwSaving: "Changing…", pwDone: "Done — password changed, other devices signed out",
  pwBack: "Back",
  ...
  tfTitle: "Two-step sign-in",
  tfOffState: "off", tfOnState: "on",
  tfLeadOff: "Besides the password, signing in will ask for 6 digits from an app on your phone — Google Authenticator, Authy or similar. Even with your password, nobody gets in without your phone.",
  tfLeadOn: "Signing in asks for a code from the app. Backup codes left: %d.",
  tfEnable: "Turn on", tfDisable: "Turn off", tfNewBackup: "New backup codes",
  tfDisableTitle: "Turn off two-step sign-in",
  tfStep1: "Open an authenticator app (Google Authenticator, Authy) and tap “+” to add an account.",
  tfStep2: "Scan the QR code. On your phone, just tap “Open in app”.",
  tfManual: "Can’t scan it? Enter the key manually:",
  tfQrAria: "QR code for the authenticator app",
  tfKeyAria: "Key for the app",
  tfCopy: "Copy", tfCopied: "Copied", tfCopyAll: "Copy all",
  tfOpenApp: "Open in app",
  tfStep3: "Enter the 6 digits the app shows.",
  tfCode: "Code from the app", tfCodeOrBackup: "App code or backup code",
  tfConfirm: "Turn on", tfBusy: "Checking…",
  tfOnDone: "Two-step sign-in is on. Other devices were signed out.",
  tfBackupTitle: "Backup codes",
  tfBackupLead: "If your phone is not at hand, sign in with one of these codes. Each works once. Save them — we will not show them again.",
  tfDownload: "Download as file", tfDone: "Done, saved",
  tfAskDisable: "To turn off two-step sign-in, enter a code from the app or a backup code.",
  tfAskBackup: "Old backup codes will stop working. Enter a code from the app or a backup code.",
  tfErrEmpty: "Enter the code", tfErrBad: "Wrong code — check that your phone's clock is accurate",
  tfErrExpired: "Time ran out — let's start over", tfErrMany: "Too many attempts — try again in %d s",
  loTitle: "Devices",
  loLead: "Signed in on someone else's computer or lost your phone? Sign out everywhere. This device stays signed in.",
  loBtn: "Sign out on all other devices", loAsk: "Sign out of the journal on all other devices?",
  loYes: "Sign out", loDone: "Done — other devices were signed out",
  ...
  suEmail: "Email",
  suTelegram: "Telegram · Danylo",
  suTelegram2: "Telegram · David",
  suWrite: "Write",
...
function applyLang(code){
  ...
  if(lo){ setTip(lo, T.sdLogoutTip); lo.setAttribute("aria-label", T.sdLogout); const sp = lo.querySelector("span"); if(sp) sp.textContent = T.sdLogout; }

  /* кнопки «Оформлення» в панелі більше немає — розділ живе в налаштуваннях */
