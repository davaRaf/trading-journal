...
uk: {
  ...
  hbEyebrow: "Останній крок", hbTitle: "Звідки ти про нас дізнався?",
  hbLead: "Одна відповідь — і в журнал. Це потрібно, щоб розуміти, де нас знаходять.",
...
ru: {
  ...
  hbEyebrow: "Последний шаг", hbTitle: "Откуда ты о нас узнал?",
  hbLead: "Один ответ — и в журнал. Это нужно, чтобы понимать, где нас находят.",
...
en: {
  ...
  hbEyebrow: "One last step", hbTitle: "How did you hear about us?",
  hbLead: "One answer and you're in. It helps us see where people find us.",
