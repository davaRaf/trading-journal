  ...
  return '<div class="nw-bar">'
    ...
    + '<div class="nw-tzwrap">'
      + '<button class="nw-tz" onclick="__news.tz()" aria-expanded="false" id="nwTzBtn">'
        ...
        + '<span class="nm">' + esc(zoneName(tz)) + '</span>'
        + '<span class="of">' + zone() + '</span>'
        + '<svg class="car" width="11" height="11" viewBox="0 0 24 24" fill="none"'
        + ' aria-hidden="true"><path d="M6 9.5 12 15.5l6-6" stroke="currentColor"'
